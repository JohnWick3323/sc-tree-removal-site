...
export const services: Service[] = [
    ...
    faqs: [
      {
        ...
        answer: 'Look for signs like deep trunk cracks, mushroom growth at the base, significant leaning toward structures, or large dead branches in the upper canopy. Our South Carolina arborists can perform a risk assessment to determine if the tree is a safety hazard or can be saved through pruning.'
      },
      {
  ...
  },
  {
    ...
    longContent: {
      intro: "Tree trimming and pruning in South Carolina is a vital investment in the longevity and safety of your landscape. Far beyond simple aesthetics, proper pruning is an arborist-led science that manages the structural integrity of the tree. In the Palmetto State, where humidity and storm cycles are intense, trees face unique biological stressors. Our pruning services are designed to mimic the natural shedding process while strategically removing hazards that threaten your home or commercial property. Whether we are shaping a young Ornamental Maple in an Upstate suburb or performing major 'Crown Reduction' on a historic oak in the Lowcountry, our goal is to enhance the tree's health while maximizing your safety. A well-pruned tree is a storm-resistant tree, and our certified arborist supervision ensures that every cut serves a specific long-term purpose.",
